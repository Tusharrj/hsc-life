...
var settings = {
  water: {
    warningMsg: 'Study time almost finish. Hurry up',
    timeIsUpMsg: 'Time\'s up. You can have a break now',
    buttonTxt: 'Study',
  ...
  coffee: {
    ...
    timeIsUpMsg: 'Time\'s up. Let\'s get to work',
    buttonTxt: 'Chillin\'',
  ...
  break: {
    warningMsg: 'Thinking is good. Think about doing something. How you can change the world!',
    timeIsUpMsg: 'Time\'s up. Now, it\'s really time to relex. Close your eyes!',
    buttonTxt: 'Brainstorming',
...
new Vue({
  ...
  methods: {
    ...
    timerResetMessage: function timerResetMessage() {
      speechSynth.text = 'Hsc Timer reset. Time left ' + this.activeReminder.durationInMinutes + ' ' + (this.activeReminder.durationInMinutes > 1 ? 'minutes' : 'minute');
      window.speechSynthesis.speak(speechSynth);
    },
